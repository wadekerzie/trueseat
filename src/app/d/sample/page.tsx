...
// The dossier page: what a candidate owns and a matched employer reads.
// This route renders the fictional sample; real dossiers will render from
// Supabase by id with the same component once auth lands.
  ...
  return (
    <main className="min-h-screen bg-[#0e1116] text-[#e8eaf0]">
      <div className="mx-auto w-full max-w-3xl px-6 py-16">
        <p className="text-xs tracking-[0.25em] uppercase text-[#E8896A] mb-8">
          Sample dossier · fictional candidate
        </p>
          ...
          <dl className="space-y-3">
            {Object.entries(d.operating_profile.manager_manual).map(([k, v]) => (
              <div key={k}>
                ...
                <dd className="text-[#c8cedb] leading-relaxed">{v as string}</dd>
              </div>
            ))}
          </dl>
        </Section>
        ...
        <footer className="pt-8 border-t border-[#1c2230] text-sm text-[#6d7585]">
          ...
          <p>
            TrueSeat · this is a fictional sample dossier ·{" "}
